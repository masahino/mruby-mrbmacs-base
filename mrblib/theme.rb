  ...
  class Theme
    ...
    def initialize
      ...
      @font_color = {
        ...
        color_linenumber: [@foreground_color, @background_color, false, false],
        color_margin_vc: [@foreground_color, 0x404040, false, false],
        color_margin_change_history: [@foreground_color, 0x404040, false, false],
        color_margin_folding: [@background_color, @background_color, false, false],
        color_marker_folding: [@background_color, @foreground_color, false, false],
