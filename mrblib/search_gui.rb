module Mrbmacs
  # Incremental search in the echo area, shared by the callback-driven (GUI)
  # frontends (cocoa, gtk). The pattern is edited directly in @frame.echo_win;
  # text changes arrive through echo_sci_notify and drive the search, while
  # control keys (C-s / C-r / Enter / C-g) arrive through echo_key_press while
  # the frame is in its non-modal echo-key mode.
